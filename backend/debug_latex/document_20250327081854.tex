...
\newcommand{\studentSignature}{\includegraphics[width=2in]{/home/diego/_Shared/_PROBE/Picton/backend/media/signatures/user_6_signature.jpg}}
\newcommand{\currentDate}{03/27/2025}

% INITIALS
\newcommand{\initFinancialAid}{DC}
\newcommand{\initInternational}{$INIT_INTERNATIONAL$}
\newcommand{\initStudentAthletes}{$INIT_STUDENT_ATHLETES$}
\newcommand{\initVeterans}{DC}
\newcommand{\initGradProfessional}{$INIT_GRAD_PROFESSIONAL$}
\newcommand{\initDoctoral}{$INIT_DOCTORAL$}
\newcommand{\initHousing}{$INIT_HOUSING$}
\newcommand{\initDining}{$INIT_DINING$}
\newcommand{\initParking}{$INIT_PARKING$}
